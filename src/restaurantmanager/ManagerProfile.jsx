...
export default function ManagerProfile() 
{
  ...
  useEffect(() => {
    console.log("Stored Manager data:", sessionStorage.getItem('manager'));
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p><strong>Restaurant Name:</strong> {manager.restaurant_name}</p>
        <p><strong>Address:</strong> {manager.restaurant_location}</p>
      </div>
    </div>
  );
}